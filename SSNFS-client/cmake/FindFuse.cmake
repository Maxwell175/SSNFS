...
if (APPLE)
	set (FUSE_NAMES libosxfuse3.dylib fuse3)
	set (FUSE_SUFFIXES osxfuse3 fuse3)
else (APPLE)
	set (FUSE_NAMES fuse3 refuse3)
	set (FUSE_SUFFIXES fuse3 refuse3)
endif (APPLE)
...
# find lib
find_library (FUSE_LIBRARIES NAMES fuse3)
